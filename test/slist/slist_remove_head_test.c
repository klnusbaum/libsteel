...
void steel_slist_remove_head_test(){
  ...
  steel_slist_test_element_t *removed_head;
  ...
  removed_head = (steel_slist_test_element_t*)steel_slist_remove_head(&my_list);


  ASSERT_TRUE(&my_element1 == removed_head, "Removed Head doesn't equal the first element.")
